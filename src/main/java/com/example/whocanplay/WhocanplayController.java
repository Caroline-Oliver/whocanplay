    ...
    public List<Map<String,String>> explore(){
        ...
        for(int i = 0; i < 3;i++){
            games.addAll(List.of(
                    ...
                    "Version 12","4 hardware CPU Threads Intel Core i5 750 or higher","Explore large, destructible environments where no two games are ever the same. Team up with friends by sprinting, climbing and smashing your way to earn your Victory Royale, whether you choose to build up in Fortnite Battle Royale or go no-builds in Fortnite Zero Build.\n" +
